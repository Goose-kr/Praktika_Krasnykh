...
public class CompanyModelTest {
    ...
    public void testSort() {
        ...
        assertEquals(settlements, new ArrayList<>(Arrays.asList(village2, city1, village1, city2)));
    ...
    public void testSortByName() {
        ...
        assertEquals(locations, new ArrayList<>(Arrays.asList(village2, city1, city1Depot, village1,
                village1Warehouse, city2, city2Warehouse, village2Waypoint, loneDepot)));
        List<Settlement> settlements = new ArrayList<>(Arrays.asList(city1, village2, city2, village1));
